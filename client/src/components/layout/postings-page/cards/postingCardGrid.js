    ...
    constructor(props) {
        ...
        this.state = {
            cardData: [
                ...
                {_id: 1, location: "Remote", datePosted: "01/04/2021", deadline: "02/07/2021", title: "Junior Backend Developer", applications: 2, applied: false},
                {_id: 2, location: "Remote", datePosted: "01/10/2021", deadline: "02/09/2021", title: "Junior Frontend Developer", applications: 6, applied: true},
                {_id: 3, location: "Remote", datePosted: "01/03/2021", deadline: "01/09/2021", title: "Senior Software Engineer", applications: 10, applied: false}
            ]
        }
        ...
        return (
            <Grid container class={"MuiGrid-container"}>
                {this.state.cardData.map((data) => {
                    return (<JobUserPostingCard changeStatus={this.handleApply} cardObject={data}></JobUserPostingCard>)
                })}
